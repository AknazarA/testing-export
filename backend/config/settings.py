...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=[
    "noble-galaxy-7746.sandbox.cayu.app",
    "*.sandbox.cayu.app",
    "*.nip.io",
    "localhost",
    "127.0.0.1",
...
# Allow Cayu domains (sandbox, production via CloudFront)
CORS_ALLOWED_ORIGIN_REGEXES = [
    r'^https://[\w-]+\.sandbox\.cayu\.app$',  # sandbox domain
    r'^https://mobile-[\w-]+\.sandbox\.cayu\.app$',  # mobile subdomain
    r'^https://[\w-]+\.cayu\.app$',  # production domain (CloudFront)
